...
enemnovo = (
    ...
    .load("s3://datalake-bruno-468906988086-igti-edc-tf/staging-zone/enem")
)
...
enemvelho = DeltaTable.forPath(spark, "s3://datalake-bruno-468906988086-igti-edc-tf/staging-zone/enem")
